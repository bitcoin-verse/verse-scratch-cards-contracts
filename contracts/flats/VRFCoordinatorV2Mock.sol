...
contract ConfirmedOwnerWithProposal is IOwnable {
    ...
    address private ZERO_ADDRESS = address(0x0);
    ...
    {
        require(
            msg.sender == s_pendingOwner,
            "Must be proposed owner"
        );

        address oldOwner = s_owner;
        s_owner = msg.sender;
        s_pendingOwner = ZERO_ADDRESS;
...
interface VRFCoordinatorV2Interface {
     ...
     * @param _subId - ID of the subscription
     * @param _newOwner - proposed new owner of the subscription
     */
     ...
     * @param _subId - ID of the subscription
     * @param _consumer - New consumer which can use the subscription
     */
...
contract VRFCoordinatorV2Mock is VRFCoordinatorV2Interface, ConfirmedOwner {
    ...
    function consumerIsAdded(
        ...
        returns (bool)
    {
        address[] memory consumers = s_consumers[
            _subId
        ];
    ...
    function removeConsumer(
        ...
        nonReentrant
    {
        address[] storage consumers = s_consumers[
            _subId
        ];
    ...
    function getFallbackWeiPerUnitLink()
        external
        pure
        returns (int256)
    {
